          ...
          <td id="daft">
            ...
            <div class="form-group row">
              ...
              <div class="col-xs-2">
                ...
                <small class="form-text text-muted"> <a href="#" style="margin-left:50px">Batal</a></small>
                <input class="btn btn-primary" type="submit" name="" value="Daftar" style="float:right; margin-bottom:20px;">
              </div>
            </div>
          </td>
          <!--BATAS -->
          <td id="form" style="margin-right:40px; height:100px;">
              <div class="form-group row">
                <div class="col-xs-2">
