...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Tentang Qoura - Quora</title>
  ...
  <body>
    <nav class="navbar navbar-expand-sm" style="border-top:1px solid red; border-bottom:1px solid #cccccc; background-color:white; padding:0px; justify-content:center;">
        ...
        <input id="search" class="form-control mr-sm-2" type="text" placeholder="  Cari pertanyaan, orang, dan topik" style="width:65%; padding:3px; ">
        <button id="btn" class="btn btn-light" type="submit">MASUK</button>
    </nav>
